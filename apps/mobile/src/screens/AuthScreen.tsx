    ...
    >
      {status === "sent" ? (
        <>
          ...
          <Text className="text-sm text-cream opacity-60">
        ...
        <>
          ...
          <TextInput
            ...
            className="rounded-lg border border-cream/20 px-4 py-3 text-cream"
          />
          <Pressable
            disabled={!canSend}
            onPress={sendMagicLink}
            className={cn(
              "rounded-lg bg-cream px-4 py-3",
          ...
          <View className="gap-3">
            <Pressable
              disabled
              className="rounded-lg border border-cream/10 px-4 py-3"
            >
              <Text className="text-center text-cream opacity-40">
